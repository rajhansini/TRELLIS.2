...
ap.add_argument('--targets',    default='qkv',
                choices=['qkv', 'qkvo', 'cross', 'cross+mlp'],
                help="qkv  = to_q + to_kv only (rung2's set on v1); "
...
import hashlib
_CFG = dict(variant='trellis2_placement_lora', blocks=args.blocks,
...
LABEL  = f'rung15_{args.blocks}_{args.targets}_r{args.rank}_s{args.seed}_{RUN_ID}'
