...
sys.argv = ['rung31_dual_attn_lora.py',
            '--mesh', MESH,
            '--gt-dir', GT_DIR,
...
import rung31_dual_attn_lora as R          # noqa: E402
...
def main():
    ...
    # ── rung31: the renderer must reproduce TRAINING exactly ────────────────
    ...
    if _TW:
        ...
        log(f'[R31] window={_TW} tokens {_nimg}->{_nimg*_TW}  '
